...
import InputDefaultColor from './color';
import $ from 'jquery';
...
class InputDefault extends Component {
  ...
  renderMask() {
    if (this.props.inputMask) {
      $(`#${this.props.inputFor}`).mask( this.props.inputMask, {
        ...this.props.inputMaskOptions, onChange: e => this.props.onChange(e)
      });
    }
  }
  ...
  render() {
    return (
      <div className={ 'input-default ' + (this.props.inputAditionalClass ? this.props.inputAditionalClass : '') }>
        ...
        { this.renderLabel() }
        { this.renderInput() }
        { (this.props.inputTypeColor === true && this.state.showColor === true) &&
          <InputDefaultColor
            onChange={ (color) => this.props.onChange( color.hex ) }
            hideColorPicker={ () => this.setState({ showColor: false }) }
...
InputDefault.propTypes = {
  ...
  inputTypeColor: PropTypes.bool,
  inputMask: PropTypes.string,
  inputMaskOptions: PropTypes.object,
